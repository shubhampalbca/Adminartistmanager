    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('manager_logout')); ?>">logout</a>
                </li>
            </ul>
        </div>
    </nav>
...
<?php /**PATH C:\wamp64\www\adminartimanager\resources\views/manager/dashboard.blade.php ENDPATH**/ ?>