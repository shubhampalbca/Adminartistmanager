               ...
               <div class="card">
                  <div class="card-body">
                     <div class="centered-image-container">
                        ...
                        <img src="{{ asset('uploads/profile/' . $adminData->profile) }}" class="main-profile-img" width="150" height="150" alt="Profile">
                        @else
                        <div class="main-profile-img bg-light d-flex align-items-center justify-content-center rounded-circle" style="width:150px;height:150px;"><i class="bi bi-person fa-3x text-muted"></i></div>
                        @endif
                        <a href="#profile-form"><i class="fa fa-edit edit-icon"></i></a>
                     </div>
                  ...
                  <div class="card-body" id="profile-form">
                     <form action="{{ url('update_admin/'.$adminData->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                           ...
                           @if(!empty($adminData->profile))
                           <img src="{{ asset('uploads/profile/' . $adminData->profile) }}" alt="Profile" width="70" height="70" class="mt-2">
                           @endif
                        </div>
