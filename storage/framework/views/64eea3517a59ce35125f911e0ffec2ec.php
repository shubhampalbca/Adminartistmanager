               ...
               <div class="card mb-4">
                  ...
                  <div class="card-body">
                     <table>
                        ...
                        <tbody>
                           <?php $__currentLoopData = $artists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <tr>
                              ...
                              <td class="name">
                                 <a href="<?php echo e(url('active-artist/'.$item->id)); ?>" class="btn btn-sm btn-<?php echo e($item->status ? 'success':'danger'); ?>">
                              ...
                              <td class="productlist">
                                 <div class="product-box">
                                    <img src="<?php echo e(asset('uploads/profile/' . $item->profile)); ?>" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" alt="fghj">
                                 </div>
                              </td>
                              <td> 
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo e(url('update-artist/'.$item->id)); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                          ...
                                          <input type="password" class="form-control" name="password" value="<?php echo e($item->password); ?>"><br>
                                          ...
                                          <img src="<?php echo e(asset('uploads/profile/' . $item->profile)); ?>"  width="50px" height="50px" alt="image" ><br><br>
                              ...
                              <a href="<?php echo e(url('delete-student/'.$item->id)); ?>" class="btn btn-danger btn-sm">Delete</a>
                             </td>
                           </tr>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                     ...
                     <br>
                     <?php echo e($artists->links('pagination::bootstrap-4')); ?>
               ...
               <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form action="<?php echo e(url('insertartist')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php if($errors->any()): ?>
...
<?php /**PATH C:\wamp64\www\adminartimanager\resources\views/admin/artist.blade.php ENDPATH**/ ?>