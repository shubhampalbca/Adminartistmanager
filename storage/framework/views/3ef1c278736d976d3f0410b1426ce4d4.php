    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo e(url('addartist')); ?>">
                        <i class="bi bi-circle"></i><span style="color: #000;">Artists Lists</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('artistevents')); ?>">
...
<?php /**PATH C:\wamp64\www\adminartimanager\resources\views/admin/include/sidebar.blade.php ENDPATH**/ ?>