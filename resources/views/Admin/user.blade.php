                           ...
                           <tr>
                              ...
                              <td class="productlist">
                                 <div class="product-box">
                                    ...
                                    <img src="{{ asset('uploads/profile/' . $item->profile) }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" alt="Profile">
                                    @else
                              ...
                              <td>
                                       ...
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="{{ url('update-user/'.$item->id) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                @if(!empty($item->profile))
                                                <img src="{{ asset('uploads/profile/' . $item->profile) }}" width="50px" height="50px" alt="Profile"><br><br>
                                                @endif
                                 ...
                                 <a href="{{ url('edit-user/'.$item->id) }}" class="btn btn-info btn-sm">View / Edit Page</a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
